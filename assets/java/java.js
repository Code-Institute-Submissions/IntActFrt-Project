      ...
      var markers = [
        {
          ...
          phone: "01594 368009",
		  content:"<div><h2>Dean Forest Cycles</h2><p>Cafe and accessory Sale</p></div>" +
		  "<div><p>Tele: 01594 368009</p></div>" + "<img src='./assets/figures/dean.png'></img>" + "<a onClick='load_shop_detail' class='detail' href='#'> book a service</a>"
        },
        {
          ...
          "<p>Tele: 01594 729000</p>" + "<img src='./assets/figures/peddle.png'></img>" + "<a onClick='load_shop_detail' class='detail' href='#'> book a service</a>"
        ...
        },
        {
          ...
          "<p>Tele: 01594 729030</p>" + "<img src='./assets/figures/sprung.png'></img>" + "<a onClick='load_shop_detail' class='detail' href='#'> book a service</a>"
...

		{
          ...
          "<p>Tele: 01633 729030</p>" + "<img src='./assets/figures/treads.png'></img>" + "<a onClick='load_shop_detail' class='detail' href='#'> book a service</a>"
        ...
        },
{
          ...
          "<p>Tele: 01633 729111</p>" + "<img src='./assets/figures/BMcycle.png'></img>" + "<a onClick='load_shop_detail' class='detail' href='#'> book a service</a>"
	     ...
	     },
{
          ...
          "<p>Tele: 01633 729791</p>" + "<img src='./assets/figures/bike.png'></img>" + "<a onClick='load_shop_detail' class='detail' href='#'> book a service</a>"
